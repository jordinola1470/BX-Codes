...
////////////////////////////////////////////////Departamento///////////////////////////////
clear all
global user "D:\Trabajo\Barómetro\BX\Darién"
cd "$user"
*cd "D:\Trabajo\Barómetro\BX\Racismo"
*D:\Trabajo\Barómetro\BX\Darién
*C:\Users\JOSE\Desktop\Trabajo\BX\Racismo
...
*Mes t-2
*CAMBIAR MES
use "Darién.dta", clear
gen people = 1
collapse (sum) people, by(residencia)
drop if (residencia == 7) | (residencia == .)
rename residencia Region
gen area = 14 if Region == 1
replace area = 37 if Region == 2
replace area = 48 if Region == 3 
replace area = 53 if Region == 4
replace area = 12 if Region == 5 
replace area = 19 if Region == 6
drop if area == .
save "Base_mapa_Darien.dta", replace
tempfile Xenofobia 
save `Xenofobia'

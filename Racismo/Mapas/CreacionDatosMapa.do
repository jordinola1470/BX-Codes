...
gen obs = _n
spmap odio using INEGI_Entidad__shp, id(obs) fcolor(Reds2) ndfcolor(dimgray) ndo(black) legstyle (1) name(Grafica_1, replace) clmethod(custom) clbreaks(0 0.2 0.4 0.6 0.8 1) title  (% Mensajes de odio Feb-07 Feb-28)
